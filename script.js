...
const demoBox = document.querySelector('.demo-instructions');
...
btnLogin.addEventListener('click', function (e) {
  ...
  currentAccount = storedAccounts.find(
...
btnSignin.addEventListener('click', function (e) {
  ...
  // Get input values
  const owner = inputSigninUsername.value.trim();
  const pin = Number(inputSigninPin.value);
  ...
  const newAccount = {
    ...
    interestRate: 1.2,
    pin: pin,
    movementsDates: ['2019-11-01T13:15:33.035Z', '2019-11-30T09:48:16.867Z'],
    currency: 'USD',
